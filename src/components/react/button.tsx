...
export const Button: FC<Props> = ({ children, onClick, props }) => (
    <button
    className="dark:text-gray-400 dark:bg-custom-dark-2 dark:hover:bg-gray-700 outline-none rounded-lg text-sm p-2.5 flex justify-center items-center duration-300 hover:shadow-xl bg-[rgba(255,255,255,0.4)] border-[1px] border-[#b4b2b27d] dark:border-custom-dark"
    onClick={onClick}
    {...props}
    >
        {children}
